...
SECRET_KEY = 'django-insecure-3hj5k^zilty4f#17nn5j(qo(_3n#gzo*&wdce1@$eijwh7k2zj'
...
AUTH_USER_MODEL = 'user.User'  # appname.modelname
...
DEFAULT_FROM_EMAIL = 'team5motion.backend@gmail.com'  # os.environ.get('DEFAULT_FROM_EMAIL')
EMAIL_USE_TLS = True  # os.environ.get('EMAIL_USE_TLS')
EMAIL_HOST = 'smtp.gmail.com'  # os.environ.get('EMAIL_HOST')
EMAIL_HOST_USER = 'team5motion.backend@gmail.com'  # os.environ.get('EMAIL_HOST_USER')
